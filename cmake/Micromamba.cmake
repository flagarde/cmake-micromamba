...
function(download_micromamba)
  ...
  file(DOWNLOAD "${SHA256_URL}" "${MICROMAMBA_DESTINATION}/${MICROMAMBA_FILENAME}-v${MICROMAMBA_VERSION}.tar.bz2.sha256" "${EXTRA_ARGUMENTS}" LOG SHA256_LOG STATUS SHA256_STATUS)
  ...
  file(DOWNLOAD "${ARCHIVE_URL}" "${MICROMAMBA_DESTINATION}/${MICROMAMBA_FILENAME}-v${MICROMAMBA_VERSION}.tar.bz2" "${EXTRA_ARGUMENTS}" LOG ARCHIVE_LOG STATUS ARCHIVE_STATUS)
